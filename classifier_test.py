...
model_Nn = nounNum.Naive_Bayes()
print model_Nn.results()

print "->Vform"
VForm = Word_error_classifier('Vform')
model_VForm = VForm.Naive_Bayes()
print model_VForm.results()

print "->Vt"
vT = Word_error_classifier('Vt')
model_vt = vT.Naive_Bayes()
print model_vt.results()

print "->Prep"
prep = Word_error_classifier('Prep')
model_prep = prep.Naive_Bayes()
print model_prep.results()

print "->ArtOrDet"
art = Word_error_classifier('ArtOrDet')
model_art = art.Naive_Bayes()
print model_art.results()
